...
> **Calibration rule:** the quality bar should accept your own real posts. Paste a few
> of them into the example section of style_guide.md, and if a rule here would reject
> one of them, change the rule — not the post.
...
- **Capability post** — introduces what a tool or idea does. Numbers optional.
...
- pass: "Three queries became one. The page now loads in half the time."
- fail: "Today I want to share a small update on my project."
...
- pass: "40% fewer database round-trips" (figure present in the bundle)
...
- pass: matches the tone and habits set in style_guide.md
